...
(function ( $ ) {
    ...
    $.fn.dynameter = function ( options ) {
        ...
        return this.each(function () {
            ...
            function updateValue (myVal, myMax, myMin) {
                var myMin = $this.data('dm-min');
	        $this.data('dm-range', myMax - myMin);
                var myRange = $this.data('dm-range');
                // Update value text.
            ...
            if (!$this.hasClass('dm-wrapperDiv')) {
                ...
                for (var key in settings.regions) {
                    ...
                    if (settings.regions[key] < settings.min || settings.regions[key] > settings.max) {
                ...
                for (var key2 in settings.regions) {
                    ...
                    if (keyIdx === 0 && settings.regions[key2] > settings.min) {
                    ...
                    colorStops.push([getAngleFromValue(settings.regions[key2]), key2]);
                    keyIdx++;
                }
            ...
            updateValue(settings.value, settings.max, settings.min);
